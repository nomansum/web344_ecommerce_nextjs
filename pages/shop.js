									...
									<div class="container mx-auto">
										{orders.map(order => (
											<div class="order-container ">
												...
												</div>{order.status === "pending" || order.status === "Not Approved" ? <p class="order-status text-red-500">{order.status}</p> : <p class="order-status text-green-500">{order.status}</p>}
